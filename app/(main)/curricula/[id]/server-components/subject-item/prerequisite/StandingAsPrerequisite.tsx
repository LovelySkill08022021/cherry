...
export default function StandingAsPrerequisite({
    ...
    return (
        <div
            className={`flex gap-2 items-center bg-gray-100 py-2 mb-3 rounded-lg px-2`}
        >
            <Button
                disabled={pending}
                ...
                variant={"outline"}
                size={"icon"}
                className="text-red-600 hover:text-red-600 border-0 shadow-none bg-white hover:bg-gray-200"
            >
                {pending ? (
